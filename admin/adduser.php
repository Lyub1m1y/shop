          ...
          <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Обновить профиль пользователя</p>
                </div>
                <div class="card-body">
                  <form action="" method="post" name="form" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="btn_save" id="btn_save" class="btn btn-primary pull-right">Обновить данные</button>
