          ...
          <div class="col-md-14">
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">Заказы <?php echo $page;?> </h4>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                      <tr><th>Имя покупателя</th><th>Состав заказа</th><th>Телефон | Email</th><th>Aдрес</th><th>Стоимость</th><th>Доставка</th><th>Время</th>
                    </tr></thead>
                    <tbody>
                      <?php 
