...
<head>
  ...
  <style>
    #navigation {
      ...
      background: -webkit-linear-gradient(to right, #white, #blue);
    ...
    #top-header {
      ...
      background: #white;
      /* fallback for old browsers */
      background: -webkit-linear-gradient(to right, #061161, #061161);
      /* Chrome 10-25, Safari 5.1-6 */
      color: #DFA611;
      /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
    ...
    #footer {
      background: #white;
      /* fallback for old browsers */
      background: -webkit-linear-gradient(to right, #348AC7, #348AC7);
      /* Chrome 10-25, Safari 5.1-6 */
      /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
    ...
    #bottom-footer {
      ...
      background: -webkit-linear-gradient(to right, #061161, #061161);
      /* Chrome 10-25, Safari 5.1-6 */
      background: linear-gradient(to right, #061161, #061161);
      /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="header-logo">
              <a href="#" class="logo">
                <font style="font-style:bold; font-size: 30px;color: white;font-family: sans-serif"><a href='index.php' style="color:white">ПИВШОП</a>
                </font>
